...
all:
	...
	~/i686-elf/bin/i386-unknown-elf-gcc $(C_TARGETS) build/ldr.o build/interrupt.o build/isr.o -o build/image.bin -nostdlib -ffreestanding -mno-red-zone -nostdlib -Wall -Wextra -T src/linker.ld -Isrc/scald-kernel/include -Os
run: all
